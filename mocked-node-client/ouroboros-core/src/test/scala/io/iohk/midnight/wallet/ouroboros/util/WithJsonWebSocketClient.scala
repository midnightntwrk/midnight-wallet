package io.iohk.midnight.wallet.ouroboros.util

import cats.effect.{IO, Resource}
import io.circe.{Decoder, Encoder}
import io.iohk.midnight.tracer.Tracer
import io.iohk.midnight.wallet.ouroboros.network.{JsonWebSocketClient, SttpJsonWebSocketClient}
...
trait WithJsonWebSocketClient extends CatsEffectSuite with BetterOutputSuite {
  ...
  implicit val clientTracer: JsonWebSocketClientTracer[IO] =
