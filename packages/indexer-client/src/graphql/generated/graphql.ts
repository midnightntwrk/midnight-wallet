...
export type BlockHashQuery = { readonly block: { readonly height: number, readonly hash: string, readonly ledgerParameters: string, readonly timestamp: number, readonly zswapEndIndex: number, readonly dustCommitmentEndIndex: number, readonly dustGenerationEndIndex: number } | null };
