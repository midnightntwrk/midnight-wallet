...
export type BlockHashQuery = { readonly block: { readonly height: number, readonly hash: string, readonly ledgerParameters: string, readonly timestamp: number, readonly zswapEndIndex: number, readonly dustCommitmentEndIndex: number, readonly dustGenerationEndIndex: number, readonly transactions: ReadonlyArray<
      | { readonly __typename: 'RegularTransaction', readonly zswapStartIndex: number, readonly zswapEndIndex: number, readonly dustGenerationStartIndex: number, readonly dustGenerationEndIndex: number, readonly dustCommitmentStartIndex: number, readonly dustCommitmentEndIndex: number, readonly dustLedgerEvents: ReadonlyArray<
...
export type DustNullifierTransactionsSubscription = { readonly dustNullifierTransactions: { readonly nullifier: string, readonly commitment: string, readonly transactionId: number, readonly transactionHash: string, readonly blockHeight: number, readonly blockHash: string } };
