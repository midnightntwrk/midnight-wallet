...
export type BlockHashQuery = { readonly block: { readonly height: number, readonly hash: string, readonly ledgerParameters: string, readonly timestamp: number, readonly zswapEndIndex: number, readonly dustCommitmentEndIndex: number, readonly dustGenerationEndIndex: number, readonly dustCommitmentMerkleTreeRoot: string | null, readonly dustGenerationMerkleTreeRoot: string | null } | null };
...
export type DustGenerationsSubscription = { readonly dustGenerations:
    | { readonly __typename: 'DustGenerationDtimeUpdateItem', readonly generationMtIndex: number, readonly newDtime: number, readonly nightUtxoHash: string, readonly treeInsertionPath: string }
    | { readonly __typename: 'DustGenerationsItem', readonly commitmentMtIndex: number, readonly generationMtIndex: number, readonly owner: string, readonly value: string, readonly initialValue: string, readonly backingNight: string, readonly ctime: number, readonly transactionId: number, readonly transactionHash: string, readonly collapsedMerkleTree: { readonly startIndex: number, readonly endIndex: number, readonly update: string, readonly protocolVersion: number } | null }
...
export type DustNullifierTransactionsSubscriptionVariables = Exact<{
  nullifierLeBytesPrefixes: ReadonlyArray<Scalars['HexEncoded']['input']> | Scalars['HexEncoded']['input'];
  fromBlock: InputMaybe<Scalars['Int']['input']>;
  toBlock: InputMaybe<Scalars['Int']['input']>;
}>;
...
export type DustNullifierTransactionsSubscription = { readonly dustNullifierTransactions: { readonly nullifierLeBytes: string, readonly commitmentLeBytes: string, readonly transactionId: number, readonly transactionHash: string, readonly blockHeight: number, readonly blockHash: string, readonly transaction:
      | { readonly __typename: 'RegularTransaction', readonly id: number, readonly hash: string, readonly dustLedgerEvents: ReadonlyArray<
          ...
          | { readonly id: number, readonly raw: string, readonly maxId: number, readonly protocolVersion: number }
          | { readonly id: number, readonly raw: string, readonly maxId: number, readonly protocolVersion: number }
        >, readonly zswapLedgerEvents: ReadonlyArray<{ readonly id: number, readonly raw: string, readonly maxId: number, readonly protocolVersion: number }>, readonly block: { readonly ledgerParameters: string } }
      | { readonly __typename: 'SystemTransaction', readonly block: { readonly ledgerParameters: string } }
     } };
...
export const DustNullifierTransactionsDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"subscription","name":{"kind":"Name","value":"DustNullifierTransactions"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"nullifierLeBytesPrefixes"}},"type":{"kind":"NonNullType","type":{"kind":"ListType","type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"HexEncoded"}}}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"fromBlock"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"Int"}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"toBlock"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"Int"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"dustNullifierTransactions"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"nullifierLeBytesPrefixes"},"value":{"kind":"Variable","name":{"kind":"Name","value":"nullifierLeBytesPrefixes"}}},{"kind":"Argument","name":{"kind":"Name","value":"fromBlock"},"value":{"kind":"Variable","name":{"kind":"Name","value":"fromBlock"}}},{"kind":"Argument","name":{"kind":"Name","value":"toBlock"},"value":{"kind":"Variable","name":{"kind":"Name","value":"toBlock"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"nullifierLeBytes"}},{"kind":"Field","name":{"kind":"Name","value":"commitmentLeBytes"}},{"kind":"Field","name":{"kind":"Name","value":"transactionId"}},{"kind":"Field","name":{"kind":"Name","value":"transactionHash"}},{"kind":"Field","name":{"kind":"Name","value":"blockHeight"}},{"kind":"Field","name":{"kind":"Name","value":"blockHash"}},{"kind":"Field","name":{"kind":"Name","value":"transaction"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"__typename"}},{"kind":"Field","name":{"kind":"Name","value":"block"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"ledgerParameters"}}]}},{"kind":"InlineFragment","typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"RegularTransaction"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"hash"}},{"kind":"Field","name":{"kind":"Name","value":"dustLedgerEvents"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"raw"}},{"kind":"Field","name":{"kind":"Name","value":"maxId"}},{"kind":"Field","name":{"kind":"Name","value":"protocolVersion"}}]}},{"kind":"Field","name":{"kind":"Name","value":"zswapLedgerEvents"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"raw"}},{"kind":"Field","name":{"kind":"Name","value":"maxId"}},{"kind":"Field","name":{"kind":"Name","value":"protocolVersion"}}]}}]}}]}}]}}]}}]} as unknown as DocumentNode<DustNullifierTransactionsSubscription, DustNullifierTransactionsSubscriptionVariables>;
