...
export type Scalars = {
  ...
  DustAddress: { input: number; output: number; }
...
export type ZswapEventsSubscription = { readonly zswapLedgerEvents: { readonly id: number, readonly raw: string, readonly maxId: number } };
