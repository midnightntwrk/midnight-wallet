...
export type DustNullifierTransactionsSubscription = { readonly dustNullifierTransactions: { readonly nullifier: string, readonly commitment: string, readonly transactionId: number, readonly transactionHash: string, readonly blockHeight: number, readonly blockHash: string, readonly transaction:
      | { readonly __typename: 'RegularTransaction', readonly id: number, readonly hash: string, readonly dustLedgerEvents: ReadonlyArray<
          | { readonly id: number, readonly raw: string, readonly maxId: number, readonly protocolVersion: number }
          | { readonly id: number, readonly raw: string, readonly maxId: number, readonly protocolVersion: number }
          | { readonly id: number, readonly raw: string, readonly maxId: number, readonly protocolVersion: number }
