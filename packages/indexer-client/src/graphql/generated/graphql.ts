...
export type BlockHashQuery = { readonly block: { readonly height: number, readonly hash: string, readonly ledgerParameters: string, readonly timestamp: number, readonly transactions: ReadonlyArray<
      | { readonly __typename: 'RegularTransaction', readonly zswapStartIndex: number, readonly zswapEndIndex: number, readonly dustGenerationStartIndex: number, readonly dustGenerationEndIndex: number, readonly dustCommitmentStartIndex: number, readonly dustCommitmentEndIndex: number }
