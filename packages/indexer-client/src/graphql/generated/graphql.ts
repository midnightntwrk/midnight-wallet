...
export type TransactionHistoryDetailQuery = { readonly transactions: ReadonlyArray<
    | { readonly __typename: 'RegularTransaction', readonly identifiers: ReadonlyArray<string>, readonly hash: string, readonly transactionResult: { readonly status: TransactionResultStatus }, readonly block: { readonly timestamp: number } }
