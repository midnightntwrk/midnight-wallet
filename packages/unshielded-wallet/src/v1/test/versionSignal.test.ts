 ...
 *   On a chain that has forked and then produced no traffic for this address, that is nothing at all, and the wallet
 *   would stay on the variant it was running with everything built through it routed to that variant's ledger.
 *
